    ...
    public abstract class GrafischObject
    {
        ...
        public Graphics Papier
        {
            ...
            set
            {
                ...
                // ddertje onder het gras is dat de VisibleClipBounds het gebied
        ...
        // eigenschappen. De methode is private omdat deze methode alleen binnen deze
        ...
        private void initClass()
        {
            ...
            // 'Globally Unique Identifier' (of 'Universally Unique Indentifier').
        ...
        protected virtual void OnOpObject(object sender)
        {
            if (OpObject != null)
            {
                // Activeren van het event OnObject
